...
Annotations can also be added by exporting to a .csv file, adding annotations in that file, and then importing the updated .csv file into a new bank.
...
Assignments can also be added by exporting to a .csv file, adding annotations for the assignment in that file, and then importing the updated .csv file into a new bank.
