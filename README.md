...
For the general scores, you can choose a general sentence to edit by selecting an option in the dropdown. change the number of sentences in the message by hitting the "Add General Sentence" button and entering in a sentence number for it in the window that appears. You can also remove the selected general sentence by hitting the "Remove General Sentence" button.
